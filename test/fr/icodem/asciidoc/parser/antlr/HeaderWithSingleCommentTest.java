        ...
        return Arrays.asList(new Object[][]{
            {
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (singleComment / /   t h i s   i s   a   c o m m e n t <EOF>)))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (singleComment / /   t h i s   i s   a   c o m m e n t   / /   i s   i t   o k   ? <EOF>)))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (singleComment / /   c o m m e n t   1 \\n) (singleComment / /   c o m m e n t   2 \\n) (singleComment / /   c o m m e n t   3 <EOF>)))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (singleComment / /   T h i s   i s   a   c o m m e n t   \\n) (header (documentTitle (title H e l l o ,   A s c i i D o c !))) (bl <EOF>))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (singleComment / /   T h i s   i s   a   c o m m e n t   \\n) (header (documentTitle (title H e l l o ,   A s c i i D o c !))) (bl \\n) (preamble (block (paragraph S o m e   t e x t . . . <EOF>))))"
            },
