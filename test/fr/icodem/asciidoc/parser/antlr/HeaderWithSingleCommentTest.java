        ...
        return Arrays.asList(new Object[][]{
            {
                ...
                /* expected */
                "(document (header (documentTitle (documentTitleValue H e l l o ,   A s c i i D o c !)) (singleComment / /   t h i s   i s   a   c o m m e n t <EOF>)))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (header (documentTitle (documentTitleValue H e l l o ,   A s c i i D o c !)) (singleComment / /   t h i s   i s   a   c o m m e n t   / /   i s   i t   o k   ? <EOF>)))"
            },
            {
                /* message */
            ...
            },
            {
                ...
                /* expected */
                "(document (singleComment / /   T h i s   i s   a   c o m m e n t   \\n) (header (documentTitle (documentTitleValue H e l l o ,   A s c i i D o c !))) (bl <EOF>))"
            },
            {
                /* message */
