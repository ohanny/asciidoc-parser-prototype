        ...
        return Arrays.asList(new Object[][]{
            {
                ...
                /* expected */
                "(document (content (preamble (block (list (listItem .   (listItemValue O r a n g e) <EOI>))))))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (content (preamble (block (list (listItem .   (listItemValue O r a n g e) \\n))))) (bl <EOI>))"
            },
            {
                /* message */
            ...
            },
            {
                ...
                /* expected */
                "(document (content (preamble (block (list (listItem .   (listItemValue F r u i t s) \\n) (listItem . .   (listItemValue C h e r r y) <EOI>))))))"
            },
            {
                /* message */
                "nested list",
