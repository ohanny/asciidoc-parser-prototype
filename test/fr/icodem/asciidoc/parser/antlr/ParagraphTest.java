        ...
        return Arrays.asList(new Object[][]{
            {
                ...
                /* expected */
                "(document (body (block (paragraph T h i s   i s   s o m e   c o n t e n t <EOF>))))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (body (block (paragraph T h i s   i s   s o m e   c o n t e n t  )) (nl \\n)) (bl <EOF>))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (body (block (paragraph T h i s   i s   s o m e   c o n t e n t   \\n o n   t w o   l i n e s <EOF>))))"
            },
            {
                /* message */
            ...
            },
            {
                ...
                /* expected */
                "(document (body (block (paragraph T h i s   i s   s o m e   c o n t e n t   w i t h   /   a n d   / /   i s   i t   o k   ? <EOF>))))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (body (block (paragraph T h i s   i s   s o m e   c o n t e n t   w i t h   / / / /   i s   i t   o k   ? <EOF>))))"
            },
            {
                /* message */
                "a paragraph containing '[' and '[['",
