    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
            ...
            },
            {
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (authors (author (authorName J o h n   D o e)) <EOF>)))"
            },
            {
                /* message */
            ...
            },
            {
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (authors (author (authorName J o h n   D o e)   < (authorAddress j d @ m a i l . c o m) >) <EOF>)))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (authors (author (authorName J o h n   D o e)) ;   (author (authorName J a n i e   R o e)) \\n)) (bl <EOF>))"
            },
            {
                /* message */
                ...
                /* expected */
                "(document (header (documentTitle (title H e l l o ,   A s c i i D o c !)) (authors (author (authorName J o h n   D o e)   < (authorAddress j d @ m a i l . c o m) >) ;   (author (authorName J a n i e   R o e)   < (authorAddress j a n i e @ m a i l . c o m) >) \\n)) (bl <EOF>))"
            },
            {
                /* message */
