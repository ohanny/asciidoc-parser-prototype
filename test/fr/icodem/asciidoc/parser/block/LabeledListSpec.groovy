...
'''
        ...
        then:
        result.tree == "(document (content (preamble (block (labeledList (labeledListItem (labeledListItemTitle t i t l e) : :   (labeledListItemContent c o n t e n t) (nl \\n)))))) (bl <EOI>))"
    }
...
'''
        ...
        then:
        result.tree == "(document (content (preamble (block (labeledList (labeledListItem (labeledListItemTitle t i t l e   1) : :   (labeledListItemContent c o n t e n t   1) (nl \\n)) (labeledListItem (labeledListItemTitle t i t l e   2) : :   (labeledListItemContent c o n t e n t   2) (nl \\n)))))) (bl <EOI>))"
