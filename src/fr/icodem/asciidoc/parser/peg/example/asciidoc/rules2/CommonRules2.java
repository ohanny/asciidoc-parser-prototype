...
import fr.icodem.asciidoc.parser.peg.example.asciidoc.listener2.SourceResolver2;
import fr.icodem.asciidoc.parser.peg.rules.Rule;

public class CommonRules2 extends BaseRules {

    private SourceResolver2 sourceResolver;
    private AttributeEntries attributeEntries;

    public CommonRules2(AttributeEntries attributeEntries) {
        this.attributeEntries = attributeEntries;
        this.sourceResolver = SourceResolver2.defaultResolver(attributeEntries);
    }

    public void withSourceResolver(SourceResolver2 resolver) {
